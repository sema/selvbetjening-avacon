...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('simpleregistration_cprnumber', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('salt', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('cpr_hash', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('simpleregistration', ['CPRnumber'])


    def backwards(self, orm):
        
        # Deleting model 'CPRnumber'
        db.delete_table('simpleregistration_cprnumber')
