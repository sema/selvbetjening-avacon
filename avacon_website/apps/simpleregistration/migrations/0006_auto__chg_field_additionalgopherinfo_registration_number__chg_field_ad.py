...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AdditionalGopherInfo.registration_number'
        db.alter_column('simpleregistration_additionalgopherinfo', 'registration_number', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'AdditionalGopherInfo.registration_number'
        raise RuntimeError("Cannot reverse this migration. 'AdditionalGopherInfo.registration_number' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'AdditionalGopherInfo.account_number'
        raise RuntimeError("Cannot reverse this migration. 'AdditionalGopherInfo.account_number' and its values cannot be restored.")
