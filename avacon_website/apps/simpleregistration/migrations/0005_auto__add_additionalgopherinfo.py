...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AdditionalGopherInfo'
        db.create_table('simpleregistration_additionalgopherinfo', (
            ...
            ('account_number', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('registration_number', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('bank_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('simpleregistration', ['AdditionalGopherInfo'])


    def backwards(self, orm):
        
        # Deleting model 'AdditionalGopherInfo'
        db.delete_table('simpleregistration_additionalgopherinfo')
    ...
    models = {
        ...
        'simpleregistration.additionalgopherinfo': {
            ...
            'account_number': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            ...
            'registration_number': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
